...
const Header = () => {
    return (
        <div className='w-screen h-[50px] flex justify-center items-center my-2'>
            <div className="w-full md:w-[62.5%] xl:w-[80%] h-full flex flex-row justify-between items-center max-sm:px-3">
                <div className="h-full w-[4rem] md:w-[4.5rem] flex items-center order-1 xl:order-0">
                    <img
                        className="size-full" 
                        src={imgLogo} 
                        alt="Logo Watch Wise"
                ...
                <div className="order-0 xl:order-1 h-full flex">
                    <div className="max-xl:hidden h-full flex flex-row justify-center items-center gap-4">
                        <div className="flex flex-row gap-1 justify-center items-center">
                            ...
                            />
                            <span className="font-nunito-sans font-extrabold text-white">
                                {user.username}
                            </span>
                        ...
                        <div className="h-full text-white flex gap-3">
                            <button 
                                className="font-nunito-sans font-extrabold"
                        ...
                        <div className="h-[38px] w-[15rem] bg-[#2c3440] flex justify-end items-center px-2 rounded-sm">
